...
| ----------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Parser**        | `@dbml/core`                                       | Tokenise and validate DBML; produce a typed JS object graph (`Database`, `Table`, `Field`, `Ref`). Extracts optional `note` strings on both `ParsedTable` and `ParsedColumn`.                                                                                                                                                                                                                                                                                                       |
| **Graph model**   | Plain TypeScript                                   | Transform the parser output into a framework-agnostic node/edge graph suitable for layout. `ParsedColumn.note` and `ParsedTable.note` carry annotation text.                                                                                                                                                                                                                                                                                                                        |
